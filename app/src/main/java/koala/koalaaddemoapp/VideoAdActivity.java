...
public class VideoAdActivity extends Activity {
    ...
    private void loadVideoAd(){
        ...
        KoalaVideoAdView koalaVideoAdView = (KoalaVideoAdView) findViewById(R.id.koala_video_ad);
        koalaVideoAdView.loadISVideoAd(adRequestSetting, new NativeAdListener.RequestVideoAdListener() {
            @Override
